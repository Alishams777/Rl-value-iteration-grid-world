...
class World:
    ...
    def __init__(self, config: Dict, game: Game, *args, **kwargs) -> None:
        """
        Constructor
        Parameters
        ----------
    ...
    def is_terminal_state(self, state: Tuple) -> bool:
        """
    ...
    def find_next_state(self, current_state: Tuple, action: str) -> Tuple:
        """
    ...
    def check_height_boundary(self, action: str) -> None:
        """
    ...
    def check_width_boundary(self, action: str) -> None:
        """
    ...
    def find_next_state_reward(self, next_state: Tuple) -> int:
        """
    ...
    def find_probaility(self, action, probabilistic_action) -> float:
        """
